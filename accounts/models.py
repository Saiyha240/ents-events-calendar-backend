...
class Profile(models.Model):
    ...
    contact_number = models.CharField(null=True, max_length=13)
    city = models.CharField(null=True, max_length=255)
    height = models.DecimalField(null=True, decimal_places=1, max_digits=4)
    weight = models.DecimalField(null=True, decimal_places=1, max_digits=4)
